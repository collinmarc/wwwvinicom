...
<div class="row addresses-lists">
	<div class="col-xs-12 col-sm-6 col-lg-4" style="">
		<ul class="myaccount-link-list">
            ...
            <li class="lnk_wishlist"><a href="{$link->getPageLink('history', true)|escape:'html':'UTF-8'}" title="{l s='Orders'}"><i class="icon-list-ol"></i><span>{l s='Order history and details'}</span></a></li>
		<li class="lnk_wishlist">
	<a 	href="http://vinicom.wine/index.php?fc=module&module=shoppinglist&controller=accountshoppinglist" title="Ma pr&eacute;-commande">
		<i class="icon-heart"></i>
		<span>Ma pr&eacute;-commande</span>
	</a>
</li>
		<li class="lnk_wishlist">
	<a 	href="http://vinicom.wine/index.php?fc=module&module=shoppinglist&controller=accountfulllistproduct" title="Le catalogue VINICOM">
		<i class="icon-search"></i>
		<span>LE CATALOGUE VINICOM</span>
	</a>
</li>
           ...
           <!-- <li><a href="{$link->getPageLink('order-slip', true)|escape:'html':'UTF-8'}" title="{l s='Credit slips'}"><i class="icon-file-o"></i><span>{l s='My credit slips'}</span></a></li>-->
			...
			<li class="mailalerts">
	<a href="http://vinicom.wine/index.php?fc=module&amp;module=mailalerts&amp;controller=account" title="Mes messages" rel="nofollow">
