                ...
                <li id="wlp_{$product.id_product}_{$product.id_product_attribute}"
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-12">
                            <div class="product_image" style="border:0px solid #000000 !important;">
...
onclick="WishlistBuyProduct('{$token_wish|escape:'htmlall':'UTF-8'}', '{$product.id_product}', '{$product.id_product_attribute}', {$product.quantity|intval}, this, true);" title="{l s='Add to cart' mod='homefeatured'}">
R&eacute;f&eacute;rencer le produit
</a>
