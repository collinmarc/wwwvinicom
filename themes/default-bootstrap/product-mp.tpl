		...
		<div class="pb-center-column col-xs-12 col-sm-4">
			...
			{$product->description}
				{foreach from=$attachments item=attachment name=attachements}
					{if $smarty.foreach.attachements.iteration %3 == 1}<div style="margin-bottom:10px;">{/if}

							<a class="btn btn-default btn-block" href="{$link->getPageLink('attachment', true, NULL, "id_attachment={$attachment.id_attachment}")|escape:'html':'UTF-8'}">
								<i class="icon-download"></i>
								Fiche technique ({Tools::formatBytes($attachment.file_size, 2)})
							</a>
...
<div class="shopping_list_block clear">
    <a data-href="{$link->getModuleLink('shoppinglist', 'ajaxproductshoppinglist', ['id_shopping_list' => $itemList.id_shopping_list, 'static_token' => $static_token])}" class="add-shopping-list btn btn-default button button-small" title="{l s='Add to my shopping list' mod='shoppinglist'}">
        <span>
