...
class SearchControllerCore extends FrontController
{
	...
	private function setShoppingListId(&$products, $shoppingListObj=null)
	{
    ...
    public function initContent()
    {
        ...
        if ($this->instant_search && !is_array($query)) {
			...
			$this->setShoppingListId($search['result'],$shoppingListObj );
		...
		//=================
               $this->context->smarty->assign('idShoppingList', $shoppingListObj->id_shopping_list); // Id shoppingList du client
		//=================
		
		$this->addCSS(_MODULE_DIR_."shoppinglist/views/css/shoppinglist2.css");  // Suppression du menu CMS
