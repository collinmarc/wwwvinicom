...
//        $this->_join = ' LEFT JOIN '._DB_PREFIX_.'address ad ON (a.id_customer = ad.id_customer and ad.active =1)';
...
/*            'total_spent' => array(
        ...
        $this->_select = '
        a.date_add,a.firstname as firstname, a.lastname as lastname, a.company as company, (
		...
		(
            SELECT ad.postCode FROM '._DB_PREFIX_.'address ad
            WHERE ad.id_customer = a.id_customer and active=1 
            ORDER BY ad.id_address ASC
            LIMIT 1
        ) as postcode,
		(
            SELECT ad.city FROM '._DB_PREFIX_.'address ad
            WHERE ad.id_customer = a.id_customer and active=1 
            ORDER BY ad.id_address ASC
            LIMIT 1
        ) as  city,
