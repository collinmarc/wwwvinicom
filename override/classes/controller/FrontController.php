...
class FrontControllerCore extends Controller
{
    ...
    public function init()
    {
        ...
        if ($this->auth && !$this->context->customer->isLogged($this->guestAllowed)) {
				// MCII 05/05/2017 : Ajout d'une trace
                PrestaShopLogger::addLog('Frontcontroller::init - Le controleur '. get_class($this).' demande un authentification, le customer n est pas loggé  => Redirection', 0, null, get_class($this), 0, false);
