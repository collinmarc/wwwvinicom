...
*}
<!-- Cheque/views/templates/hook/payment_return.tpl -->
{if $status == 'ok'}
	...
	<!--<div class="box order-confirmation">
		...
		<br />- {l s='Payable to the order of' mod='cheque'} <strong>{if $chequeName}{$chequeName}{else}______ghghghghghghghgh_____{/if}</strong>
...
{else}
	...
	<li>
		<a class="btn btn-default button button-small" href="http://pgweb.me/vinicom2015/index.php?controller=my-account">
			<span>
				<i class="icon-chevron-left"></i> Retour à votre compte
			</span>
		</a>
	</li>
	<li>
		<a class="btn btn-default button button-small" href="http://pgweb.me/vinicom2015/">
