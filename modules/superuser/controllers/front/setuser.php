...
{
	// MCI 05/05/2017 : Ce controler ne demande par d'authentification
    public $auth = false;
    ...
    public function initContent()
    {
        ...
        if ($customer_secure_key != $param_secure_key) {
			//MCII 05/05/2017 => Redirection sur MonCompte
            Tools::redirect(_PS_BASE_URL_.__PS_BASE_URI__. "/index.php?controller=my-account");
        }
    ...
    private function setCookie($customer, $shop, $use_last_cart = '1')
    {
        if (version_compare(_PS_VERSION_, '1.5', '<')) {
            ...
            if (Tools::getValue('id_customer')) {
				...
				$cookie->company = $customer->company;
